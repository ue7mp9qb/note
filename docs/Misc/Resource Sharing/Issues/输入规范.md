...
# 不改变默认文件名的命名方式, 如: Burp Suite 的默认安装目录文件名为 BurpSuitePro 
# 创建的新文件遵循关联目录的命名方式, 如: 在 BurpSuitePro 中创建目录文件 Extensions
...
每种漏洞的都以 [PortSwigger](https://portswigger.net/web-security/all-topics) 为框架, 漏洞报告则参考 [HackerOne](https://hackerone.com/hacktivity/).
